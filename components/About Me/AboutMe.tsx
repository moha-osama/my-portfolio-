      ...
      <div className="flex items-center">
        <div className="grid max-w-screen-xl px-4 py mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="lg:col-span-7 flex justify-around flex-col">
            <p>
              viverra enim. Cras dolor sapien varius nisl. vehicula, amet, diam
              scelerisque odio eget nisi amet, elementum est. cursus at nibh
              orci orci ultrices In libero, venenatis ex nulla, urna. faucibus
              libero, lorem. id porta commodo dignissim, vitae Vestibulum
              efficitur. ex est. tempor nibh non. ipsum Sed at, sit dolor Morbi
              amet, sodales. massa lorem. tincidunt lacus, ipsum non Vestibulum
              scelerisque non odio varius ac enim. tincidunt nec tortor.
              consectetur Morbi consectetur
            </p>
